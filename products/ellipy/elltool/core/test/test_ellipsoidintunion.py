...
class TestEllipsoidIntUnionTC:
    ...
    # def flex_assert(se):
    # __IS_ASSERTION_ON = True
    # if __IS_ASSERTION_ON:
    ...
    def test_is_internal(self):
        ...
        test_point_vec = np.array([[1, 0], [2, 0]]).T
    ...
    def test_polar(self):
        ...
        # assert ABasicEllipsoid.eq(np.array([test_ell_vec]), polar_ellipsoid.flatten())                    # !!!!!!!!!!
        # self.flex_assert(True, eq(test_ell_vec, polar_ellipsoid))
        ...
        # assert ABasicEllipsoid.eq(np.array([ans_ell_vec]), polar_ell_vec.flatten())                       # !!!!!!!!!!
        ...
        # assert polar_ell_vec == ans_ell_vec                                                                 # !!!!!!!!
        # assert ABasicEllipsoid.eq(np.array([ans_ell_vec]), polar_ell_vec.flatten())
